  ...
  const features = [
    {
      ...
      title: t('service.features.performance.title'),
      description: t('service.features.performance.desc')
    },
    {
      icon: (
        <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: t('service.features.security.title'),
      description: t('service.features.security.desc')
    },
    {
      icon: (
        <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: t('service.features.reliability.title'),
      description: t('service.features.reliability.desc')
    },
    {
      icon: (
        <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: t('service.features.mobile.title'),
      description: t('service.features.mobile.desc')
    },
    {
      icon: (
        <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: t('service.features.analytics.title'),
      description: t('service.features.analytics.desc')
    },
    {
      icon: (
        <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: t('service.features.support.title'),
      description: t('service.features.support.desc')
    }
  ];
