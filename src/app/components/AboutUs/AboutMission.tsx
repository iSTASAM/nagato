          ...
          <div>
            <div className="space-y-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">{t('about.mission.main.title')}</h3>
                  <p className="text-gray-600 leading-relaxed">
                    {t('about.mission.main.desc')}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">{t('about.mission.vision.title')}</h3>
                  <p className="text-gray-600 leading-relaxed">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">{t('about.mission.values.title')}</h3>
                  <p className="text-gray-600 leading-relaxed">
                    {t('about.mission.values.desc')}
                  </p>
                </div>
              </div>
            </div>
